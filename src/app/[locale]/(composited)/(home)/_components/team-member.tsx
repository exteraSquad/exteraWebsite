...
export default function TeamMember({href, name, role, img, buttonText}: TeamMemberProps) {
    return (
        <figure
            className="group border-2 border-neutral-300 rounded-4xl p-8 flex flex-col justify-center duration-300 ease-in-out
        ...
        >
            ...
            <div className="w-full flex-1" />
            <Link
                className="translate-y-28 group-hover:translate-y-0 transition-transform w-full py-3 md:py-6 text-xl md:text-2xl
